...
<!--Chaque axe à un btn pour afficher son contenu-->
<button onclick="hideAndDisplay('contenu1')">Axe Compétences</button>
<br>
<!--On affiche le contenu de l'axe en question si on a cliqué sur le btn-->
<div id="contenu1" style="display: none">
    <h3>Excellence Technique/Communauté de pratiques</h3>
    ...
    <h3>Gestion humaine des compétences</h3>
    <div>
...
<div id="contenu3" style="display: none">
    ...
    <div>
        <h4>Comment utilisez-vous le numérique dans la relation client ? (nouveau modèle de vente, nouveau modèle d’échanges avec les clients, communauté, story, chat,...)</h4>
        <div>La réponse</div>
        <div>Le conseil</div>
    </div>
    <div>
